...
## **9. # Image Annotation and Object Detection Workflow: ARAMSAM + YOLO + SAHI
This documentation provides a complete end-to-end workflow for image annotation, **YOLO model training**, tiled inference evaluation with **SAHI**, and establishing a continuous improvement loop.
...
- Re-evaluate using SAHI to confirm reliability and robustness.
## **9. Training set up**
All models were trained using datasets annotated with ARAMSAM, several training scripts were created to run experiments using YOLO11. Three model variants were tested systematically.
